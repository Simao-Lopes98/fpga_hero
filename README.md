...
## APIO
Using APIO to build, synth, test and upload.

To install follow [Getting Started](https://fpgawars.github.io/apio/docs/installing-apio-cli/#install-using-a-file-bundle_2)
